...
- **Deploy:** ทดลองขึ้น **Railway สำเร็จแล้ว** (`docs/แผน-ทดลอง-railway-free.md` มีผลจริง + กับดัก 5 ข้อ · พิสูจน์แล้วว่า volume เก็บข้อมูลข้าม deploy ได้) · ทางเลือกที่แนะนำระยะยาว = **NAS + Cloudflare Tunnel** (`docs/แผน-ย้ายไป-nas-cloudflare.md` — ติดที่ยังไม่รู้ว่า NAS รุ่นอะไร ต้องทำ Phase 0 ก่อน)
- ขั้นถัดไปอื่น (backlog): **สำรอง dev.db อัตโนมัติ** (ยังไม่มี — เสี่ยงสุด), เปิด groundwork equipment/test method, ตั้ง cron แจ้งเตือนจริง — รวมทั้งหมดใน `docs/โครงสร้างโปรเจค-webapp.md`
