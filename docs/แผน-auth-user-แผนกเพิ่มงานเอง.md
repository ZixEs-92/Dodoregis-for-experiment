...
> เอกสารแผน (Phase 3) · อัปเดต 2026-07-31 — **✅ เสร็จครบทุก sub-phase แล้ว (3a/3b/3c/3d/3e)** · เอกสารนี้เก็บไว้อ้างอิงการออกแบบ
...
**ความคืบหน้า (2026-07-31): ✅ Phase 3 เสร็จครบ** — login/session (bcrypt + jose cookie 8ชม.), 4 roles, กันสิทธิ์ฝั่ง server ทุก action + page guard + ซ่อน UI ตาม role · **จัดการผู้ใช้ `/settings/users`** (สร้าง/ตั้งรหัส/ปิดบัญชี ผ่านหน้าเว็บ) · **requester portal**: `ownerId` nullable, แผนกล็อกฝั่ง server, เห็นเฉพาะแผนกตัวเอง, ช่อง owner/plan ซ่อน, "ยังไม่มอบหมาย" ทุกหน้า, `changedBy` จาก session · **คิวรอวางแผน `/planning`** (admin มอบหมาย + ลงวันที่, โชว์คิวงานต่อคน, item ยังไม่มอบหมายเดินหน้าเกินสถานะ 2 ไม่ได้) · **หน้าแรกของแอป = หน้า login** (ประตูทางเข้า: สแกน QR / ดูรายการงานไม่ต้องล็อกอิน / ล็อกอิน)
